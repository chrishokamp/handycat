describe("Unit: Testing the SegmentAreaCtrl", function() {
  ...
  beforeEach(function() {
    ...
    inject(function($controller, $rootScope, $compile) {
      ...
      ctrl = $controller('SegmentAreaCtrl', {$scope: scope, Wikipedia:{}, Glossary:{}, GermanStemmer:{}, ruleMap:{}, copyPunctuation:{}, Morphology: {}, Document:{}, project:{}, entityLinker: {}, entityDB: {} });
    });
  });
